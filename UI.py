...
from utils import *
from reports import TrafficViolationReport
...
class UI:
    ...
    def print_report(self, violation_record):
        report = TrafficViolationReport()
        report.set_data(violation_record[1].values[0], violation_record[2].values[0], violation_record[3].values[0], violation_record[4].values[0], violation_record[5].values[0], violation_record[6].values[0])
        report.generate_pdf(f"reports/report-{violation_record[2].values[0]}.pdf")
        sg.popup("Report generated and saved successfully!")
